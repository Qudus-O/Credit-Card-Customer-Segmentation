...
It takes raw, chaotic transaction data and uses **Unsupervised Machine Learning** to tell the story of who these customers actually are. By looking beyond simple demographics and diving into behavioral patterns, this "KYC Engine" clusters users into distinct personas—separating the "Big Spenders" from the "Cautious Savers."
...
---
*Ready to explore the code? Check out the Jupyter Notebook in this repository.*
